...
In order to have that statement to be true we need that both sides of the $\implies$ connective, have to be true. In the example give, the right side is not given by assumption to be always true 
