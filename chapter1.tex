...
And get as expression $a_n= \frac{1}{3}n^3+\half n^2+\frac{1}{6}n$ which can be rewritten as 
...
\subsection{}
\begin{tcolorbox}
Let a be the sequence given by $a_n= \sqrt{n+1} -\sqrt{n}$. Find an integer $N$ such that for $n\ge  N,\, a_{n+1} < a_n$. Find an integer $M$ such that for $n\ge M, \, a_n\le \frac{1}{16}$.
\end{tcolorbox}
$$ $$
$$\blacklozenge$$
...
\subsection{}
\begin{tcolorbox}
For each $(x, y)\in \Breal^2$, let $f(x, y) = (x2 ^-y^2, 2xy)$. Let the point $p_1$ in the plane be given by $f(\half,\half),\, p_2 = f(p_1),\, p_3 = f(p_2),\, p_4= f(p_3),\, p_5 = f(p_4)$. Calculate and plot the points $p_1,\, p_2,\,\dots,\,p_5$.
\end{tcolorbox}
$$ $$
$$\blacklozenge$$
...
\subsection{}
\begin{tcolorbox}
Let $A_l = \{I, 2, 3\}, A_2 = \{1, 2\}, A_3 = \{a,b\}$.  Write out the elements of $A_1 \times A_2\times A_3$. Write out the elements of $(A_1\times A_2) \times A_3$. Show that there is a "natural" one-to-one correspondence between the elements of these two sets. 
\end{tcolorbox}
$$ $$
$$\blacklozenge$$
...
\subsection{}
\begin{tcolorbox}
Let $A_l$ be the set of all real numbers $\Breal$. For each $i \in \mathbb{P}$ such that $i \ge 2$, let $A_i=\{0\}$. Describe in words the set $\bigtimes \{A_i: i \in \mathbb{P}\}$. Show that there exists a bijection from $\bigtimes \{A_i: i \in \mathbb{P}\}$ onto $\Breal$.
\end{tcolorbox}
$$ $$
$$\blacklozenge$$