...
\begin{figure}[H]%
    \centering
    \subfloat[$S^{*}\cap C^{}=\emptyset,\,C^{*}= C^{} $]{\input{./images/fig_1.27.6_a.tex}}
    \subfloat[$S^{*}\cap C^{}\neq\emptyset,\,C^{*}\cap C^{}\neq\emptyset,\,C^{*}\neq C^{} $]{\input{./images/fig_1.27.6_b.tex}} \\  		                     	\subfloat[$S^{*}\cap C^{}\neq\emptyset,\,C^{*}\cap C^{}=\emptyset $]{\input{./images/fig_1.27.6_c.tex}}
    	\subfloat[$S^{*}\cap C^{}=\emptyset,\,C^{*}\cap C^{}\neq\emptyset,\,C^{*}\neq C^{} $]{\input{./images/fig_1.27.6_d.tex}}
%\caption{}
\label{fig:fig_p3}
\end{figure}
