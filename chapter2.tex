...
\end{tcolorbox}
As $$\bigcap\mathscr{K}\neq \emptyset$$ there exists at least one  $x\in I_i,\, \forall I_i\in \mathscr{K}$.\\\\
As the $I_i$ are intervals, we have for all $a_i,\, b_i \in I_i$ with $a_i\leq b_i$ such that $[a_i,\, b_i]\subset I_i$
$$\blacklozenge$$
\newpage
