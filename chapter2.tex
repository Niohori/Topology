...
\textit{( This means that $\forall m\in\Pee: X_{m} \neq\emptyset$ as otherwise the sequence by construction, would be finite.)}\\
...
\hline
 $X_{n_{m-1}}\cap K^{*}_{n_{m-1}}$ &  $=X_{n_{m-1}}$ (closed) &    $=K^{*}_{n_{m-1}}$ (open)& $\neq\emptyset$ (open) &  $=\emptyset$  (open/closed)\\ 
 \hline
 $X_{n_{m-1}}-(X_{n_{m-1}}\cap K^{*}_{n_{m-1}})$& $\emptyset$& \input{./images/fig_2.43.1.4_b2.tex} & \input{./images/fig_2.43.1.4_c2.tex} & \input{./images/fig_2.43.1.4_d2.tex}\\ 
\hline
